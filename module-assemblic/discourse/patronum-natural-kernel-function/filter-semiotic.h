...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_function_)					= typename pnk_function_as::filter::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_function_)		= pnk_function_as::filter::template
										  a_function_<Type, Continuation, Image>;

//

	static constexpr void (*nik_safe(PREFIX, p_function_))() =
		pnk_function_as::filter::p_function_;
