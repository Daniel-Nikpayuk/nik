...
#define snk_wchar_t_judgement_as nik_module(straticum, natural, kernel, wchar_t_judgement, assemblic, semiotic)
	...
	#define PREFIX		snkw_embedding_as_
...
//
										  ...
										  <
											...
											ch_symbolic_values
										  >
	using nik_safe(PREFIX, s_wchar_t_judgement_)					= typename snk_wchar_t_judgement_as::embedding::template
...
//
										  ...
										  <
											...
											ch_assemblic_value
										  >
	static constexpr void nik_safe(PREFIX, a_wchar_t_judgement_)			= snk_wchar_t_judgement_as::embedding::template
