...
//
										  ...
										  <
											...
											ch_symbolic_values
										  >
	using nik_safe(PREFIX, s_is_signed_long_equal)				= typename snk_signed_long_judgement_as::identity::template
...
//
	...
	static constexpr bool (*nik_safe(PREFIX, p_is_signed_long_equal))(signed long, signed long) =
		snk_signed_long_judgement_as::identity::p_is_signed_long_equal;
