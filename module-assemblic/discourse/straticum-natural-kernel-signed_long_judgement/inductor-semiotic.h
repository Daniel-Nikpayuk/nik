...
//
										  ...
										  template<auto Value>
	using nik_safe(PREFIX, pattern_match_signed_long_judgement)			= typename snk_signed_long_judgement_as::inductor::template
										  pattern_match_signed_long_judgement<Value>;
