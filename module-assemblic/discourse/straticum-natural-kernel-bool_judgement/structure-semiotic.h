...
#define snk_bool_judgement_as nik_module(straticum, natural, kernel, bool_judgement, assemblic, semiotic)
	...
	#define PREFIX		snkb_structure_as_
...
//
										  ...
										  <
											...
											ch_assemblic_value
										  >
	static constexpr void nik_safe(PREFIX, a_bool_judgement_)			= snk_bool_judgement_as::structure::template
										  a_bool_judgement_<Type, Continuation>;

//

	static constexpr void (*nik_safe(PREFIX, p_bool_judgement_))()		= snk_bool_judgement_as::structure::
												  p_bool_judgement_;
