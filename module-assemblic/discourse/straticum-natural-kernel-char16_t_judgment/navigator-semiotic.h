...
//
										  ...
										  <
											...
											ch_assemblic_value
										  >
	static constexpr void nik_safe(PREFIX, a_char16_t_judgment_)			= snk_char16_t_judgment_as::navigator::template
										  a_char16_t_judgment_<Type, Continuation>;

//

	static constexpr void (*nik_safe(PREFIX, p_char16_t_judgment_))()		= snk_char16_t_judgment_as::navigator::
