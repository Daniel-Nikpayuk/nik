...
//
										  ...
										  <
											...
											ch_symbolic_values
										  >
	using nik_safe(PREFIX, s_is_unsigned_long_equal)				= typename snk_unsigned_long_judgement_as::identity::template
...
//
	...
	static constexpr bool (*nik_safe(PREFIX, p_is_unsigned_long_equal))(unsigned long, unsigned long) =
		snk_unsigned_long_judgement_as::identity::p_is_unsigned_long_equal;
