...
//
										  ...
										  <
											...
											ch_symbolic_values
										  >
	using nik_safe(PREFIX, s_is_signed_char_equal)				= typename snk_signed_char_judgement_as::identity::template
...
//
	...
	static constexpr bool (*nik_safe(PREFIX, p_is_signed_char_equal))(signed char, signed char) =
		snk_signed_char_judgement_as::identity::p_is_signed_char_equal;
