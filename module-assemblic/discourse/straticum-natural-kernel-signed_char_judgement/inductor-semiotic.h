...
//
										  ...
										  template<auto Value>
	using nik_safe(PREFIX, pattern_match_signed_char_judgement)			= typename snk_signed_char_judgement_as::inductor::template
										  pattern_match_signed_char_judgement<Value>;
