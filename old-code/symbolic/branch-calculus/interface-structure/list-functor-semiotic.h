...
//
							  ...
							  template
							  <
								typename Type, typename Op_Cond, Type Result, typename List,
								typename Continuation = local_callif_ch_builtin_list
							  >
	using nik_safe(PREFIX, builtin_break_fold)	= typename nik_module(list, calculus, symbolic, semiotic)::functor::template
							  builtin_break_fold<Type, Op_Cond, Result, List, Continuation>;
...
//
							  ...
							  <
								typename Kind, template<Kind...> class ListKind,
								typename Type, typename Op_Cond, typename List1, typename List2,
								typename Continuation = local_callif_ch_builtin_list
							  >
	using nik_safe(PREFIX, builtin_split_zip)	= typename nik_module(list, calculus, symbolic, semiotic)::functor::template
							  builtin_split_zip<Kind, ListKind, Type, Op_Cond, List1, List2, Continuation>;
...
//
							  ...
							  <
								typename Kind, template<Kind...> class ListKind,
								typename Type, typename Op_Cond, typename List, typename Continuation
							  >
	using nik_safe(PREFIX, builtin_split_map)	= typename nik_module(list, calculus, symbolic, semiotic)::functor::template
							  builtin_split_map<Kind, ListKind, Type, Op_Cond, List, Continuation>;
...
//
							  ...
							  template<typename Op_Cond, typename List1, typename List2, typename Continuation>
	using nik_safe(PREFIX, typename_split_zip)	= typename nik_module(list, calculus, symbolic, semiotic)::functor::template
							  typename_split_zip<Op_Cond, List1, List2, Continuation>;

//

							  template<typename Op_Cond, typename List, typename Continuation>
	using nik_safe(PREFIX, typename_split_map)	= typename nik_module(list, calculus, symbolic, semiotic)::functor::template
							  typename_split_map<Op_Cond, List, Continuation>;
*/
