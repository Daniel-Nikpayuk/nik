...
namespace grammaric	{
	...
	struct module<Module::applicative, Orientation::structural, Interface::semiotic, SizeType>
	{
		typedef SizeType size_type;

		using identifier = module<Module::identifier, Orientation::functional, Interface::semiotic, size_type>;
		using functional = module<Module::applicative, Orientation::functional, Interface::semiotic, size_type>;
