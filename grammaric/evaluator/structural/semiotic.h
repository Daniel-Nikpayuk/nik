...
namespace grammaric	{
	...
	struct module<Module::evaluator, Orientation::structural, Interface::semiotic, SizeType>
	{
		...
		using functional = module<Module::evaluator, Orientation::functional, Interface::semiotic, size_type>;
