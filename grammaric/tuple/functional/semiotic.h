...
namespace grammaric	{
	...
	struct module<Module::tuple, Orientation::functional, Interface::semiotic, SizeType>
	{
		typedef SizeType size_type;

//		struct module<Module::tuple, Orientation::structural, Interface::semiotic, size_type>;
		...
		// Translational:
			...
			#include"parameter/semiotic.hpp"
	};
