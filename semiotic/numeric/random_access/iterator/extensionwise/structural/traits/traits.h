...
#ifndef NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_STRUCTURAL_TRAITS_H
#define NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_STRUCTURAL_TRAITS_H
...
*/
			template<typename T>
			using hook=structural::hook<T, size_type>;

			template<typename T>
			using const_hook=structural::const_hook<T, size_type>;
	};
      }
     }
    }
