...
#ifndef NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_ARITHMETIC_H
#define NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_ARITHMETIC_H
   ...
   namespace random_access
   {
    namespace iterator
    {
     namespace extensionwise
     {
      ...
      {
       namespace forward // no direction anymore!
       {
...
*/
			struct zero
			{
				...
				{
					carry=carry && !*in;
					unroll<N-1>::zero::no_break(carry, ++in);
				}
/*
	If return == end, then the iterated container property is true.
*/
				...
				{
					if (*in) return in;
					else return unroll<N-1>::zero::with_break(++in);
				}
				...
				struct fast
				{
					...
					{
						carry=carry && !*in;
						return unroll<N-1>::zero::fast::no_break(carry, ++in);
					}
/*
	If return == end, then the iterated container property is true.
*/
					...
					{
						if (*in) return false;
						else return unroll<N-1>::zero::fast::with_break(++in);
					}
				};
			};
/*
...
*/
			struct equal
			{
				...
				{
					carry=carry && (*in1 == *in2);
					unroll<N-1>::equal::no_break(carry, ++in1, ++in2);
				}
/*
	If return == end, then the iterated container property is true.
*/
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::equal::with_break(++in1, ++in2);
				}
				...
				struct fast
				{
					...
					{
						carry=carry && (*in1 == *in2);
						return unroll<N-1>::equal::fast::no_break(carry, ++in1, ++in2);
					}
/*
	If return == end, then the iterated container property is true.
*/
					...
					{
						if (*in1 != *in2) return false;
						else return unroll<N-1>::equal::fast::with_break(++in1, ++in2);
					}
				};
			};
/*
...
*/
			struct not_equal
			{
				...
				{
					carry=carry || (*in1 != *in2);
					unroll<N-1>::not_equal::no_break(carry, ++in1, ++in2);
				}
/*
	If return == end, then the iterated container property is false.
*/
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::not_equal::with_break(++in1, ++in2);
				}
				...
				struct fast
				{
					...
					{
						carry=carry || (*in1 != *in2);
						return unroll<N-1>::not_equal::fast::no_break(carry, ++in1, ++in2);
					}
/*
	If return == end, then the iterated container property is false.
*/
					...
					{
						if (*in1 != *in2) return true;
						else return unroll<N-1>::not_equal::fast::with_break(++in1, ++in2);
					}
				};
			};
/*
...
*/
			struct less_than
			{
				...
				static void no_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					unroll<N-1>::less_than::no_return(carry, ++in1, ++in2);
				}
				...
				static Iterator1 with_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::less_than::with_return(carry, ++in1, ++in2);
				}
				...
				static bool fast_return(bool carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::less_than::fast_return(carry, ++in1, ++in2);
				}
				...
				static bool fast_return(bool carry, Iterator1 in1, Iterator2 in2, size_type order1, size_type order2)
				{
					return (order1 < order2 || (order1 == order2 &&
						unroll<N>::less_than::fast_return(carry, in1, in2)));
				}
			};
/*
	carry is the overhead value. Set this to true for the "normal" interpretation. 
...
*/
			struct less_than_or_equal
			{
				...
				static void no_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					unroll<N-1>::less_than_or_equal::no_return(carry, ++in1, ++in2);
				}
				...
				static Iterator1 with_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::less_than_or_equal::with_return(carry, ++in1, ++in2);
				}
				...
				static bool fast_return(bool carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::less_than_or_equal::fast_return(carry, ++in1, ++in2);
				}
				...
				{
					return (order1 < order2 || (order1 == order2 &&
						unroll<N>::less_than_or_equal::fast_return(carry, in1, in2)));
				}
			};
/*
	carry is the overhead value. Set this to false for the "normal" interpretation. 
...
*/
			struct greater_than
			{
				...
				static void no_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					unroll<N-1>::greater_than::no_return(carry, ++in1, ++in2);
				}
				...
				static Iterator1 with_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::greater_than::with_return(carry, ++in1, ++in2);
				}
				...
				static bool fast_return(bool carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::greater_than::fast_return(carry, ++in1, ++in2);
				}
				...
				{
					return (order1 > order2 || (order1 == order2 &&
						unroll<N>::greater_than::fast_return(carry, in1, in2)));
				}
			};
/*
	carry is the overhead value. Set this to true for the "normal" interpretation. 
...
*/
			struct greater_than_or_equal
			{
				...
				static void no_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					unroll<N-1>::greater_than_or_equal::no_return(carry, ++in1, ++in2);
				}
				...
				static Iterator1 with_return(bool & carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::greater_than_or_equal::with_return(carry, ++in1, ++in2);
				}
				...
				static bool fast_return(bool carry, Iterator1 in1, Iterator2 in2)
				{
					...
					return unroll<N-1>::greater_than_or_equal::fast_return(carry, ++in1, ++in2);
				}
				...
				{
					return (order1 > order2 || (order1 == order2 &&
						unroll<N>::greater_than_or_equal::fast_return(carry, in1, in2)));
				}
			};
/*
...
*/
			struct plus
			{
				...
				static void no_return(ValueType carry, WIterator out, RIterator1 in1, RIterator2 in2)
				{
					...
					*out=carry + *in2;
					carry=(carry < *in1 || *out < *in2);
					unroll<N-1>::plus::no_return(carry, ++out, ++in1, ++in2);
				}
				...
				static WIterator with_return(ValueType carry, WIterator out, RIterator1 in1, RIterator2 in2)
				{
					...
					*out=carry + *in2;
					carry=(carry < *in1 || *out < *in2);
					return unroll<N-1>::plus::with_return(carry, ++out, ++in1, ++in2);
				}
/*
	If an arithmetic overflow occurs beyond the half, it will only effect the first digit above.
*/
...
*/
			struct minus
			{
				...
				static void no_return(ValueType carry, WIterator out, RIterator1 in1, RIterator2 in2)
				{
					...
					*out=*in1 - carry;
					carry=(carry < *in2 || *in1 < *out);
					unroll<N-1>::minus::no_return(carry, ++out, ++in1, ++in2);
				}
				...
				static WIterator with_return(ValueType carry, WIterator out, RIterator1 in1, RIterator2 in2)
				{
					...
					*out=*in1 - carry;
					carry=(carry < *in2 || *in1 < *out);
					return unroll<N-1>::minus::with_return(carry, ++out, ++in1, ++in2);
				}
			...
			struct assign
			{
				struct plus
				{
					...
					static void no_return(ValueType carry, WIterator out, RIterator in)
					{
						...
						*out+=carry;
						carry=(carry < *in || *out < carry);
						unroll<N-1>::assign::plus::no_return(carry, ++out, ++in);
					}
					...
					static WIterator with_return(ValueType carry, WIterator out, RIterator in)
					{
						...
						*out+=carry;
						carry=(carry < *in || *out < carry);
						return unroll<N-1>::assign::plus::with_return(carry, ++out, ++in);
					}
/*
	If an arithmetic overflow occurs beyond the half, it will only effect the first digit above.
*/
...
*/
				struct minus
				{
					...
					static void no_return(ValueType carry, WIterator out, RIterator in)
					{
						...
						*out-=carry;
						carry=(carry < *in || before < *out);
						unroll<N-1>::assign::minus::no_return(carry, ++out, ++in);
					}
					...
					static WIterator with_return(ValueType carry, WIterator out, RIterator in)
					{
						...
						*out-=carry;
						carry=(carry < *in || before < *out);
						return unroll<N-1>::assign::minus::with_return(carry, ++out, ++in);
					}
...
*/
			struct less_than
			{
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::less_than::with_break(--in1, --in2);
				}
				...
				{
					if (*in1 != *in2) return (*in1 < *in2);
					else return unroll<N-1>::less_than::fast_break(--in1, --in2);
				}
			};
/*
	If return == end, then the iterated container property is true.
...
*/
			struct less_than_or_equal
			{
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::less_than_or_equal::with_break(--in1, --in2);
				}
				...
				{
					if (*in1 != *in2) return (*in1 < *in2);
					else return unroll<N-1>::less_than_or_equal::fast_break(--in1, --in2);
				}
			};
/*
	If return == end, then the iterated container property is true.
...
*/
			struct greater_than
			{
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::greater_than::with_break(--in1, --in2);
				}
				...
				{
					if (*in1 != *in2) return (*in1 > *in2);
					else return unroll<N-1>::greater_than::fast_break(--in1, --in2);
				}
			};
/*
	If return == end, then the iterated container property is true.
...
*/
			struct greater_than_or_equal
			{
				...
				{
					if (*in1 != *in2) return in2;
					else return unroll<N-1>::greater_than_or_equal::with_break(--in1, --in2);
				}
				...
				{
					if (*in1 != *in2) return (*in1 > *in2);
					else return unroll<N-1>::greater_than_or_equal::fast_break(--in1, --in2);
				}
			};
/*
			Intuitively, "right_shift" would be defined here,
