...
#ifndef NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_ORDER_H
#define NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_ORDER_H
  ...
  namespace numeric
  {
   namespace random_access
   {
	...
	struct order
	{
		...
		typedef processor::policy<size_type> c_policy;
