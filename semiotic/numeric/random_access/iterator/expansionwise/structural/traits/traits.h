...
#ifndef NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXPANSIONWISE_STRUCTURAL_TRAITS_H
#define NIK_SEMIOTIC_NUMERIC_RANDOM_ACCESS_ITERATOR_EXPANSIONWISE_STRUCTURAL_TRAITS_H
...
*/
			template<typename T>
			using link=structural::link<T, size_type>;

			template<typename T>
			using const_link=structural::const_link<T, size_type>;
	};
      }
     }
    }
