...
//
	...
	using null_arguments	= typename nik_module(lambda, interpreted, calculus, semiotic)::structure::template
				  arguments<>;
	...
	using null_body		= typename nik_module(lambda, interpreted, calculus, semiotic)::structure::template
				  body<>;
