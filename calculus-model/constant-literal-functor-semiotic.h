...
//
							  ...
							  template
							  <
								nik_module(literal, constant, calculus, semiotic)::register_type Value,
								typename List
							  >
	...
	using nik_safe(PREFIX, at)			= typename nik_module(literal, constant, calculus, semiotic)::functor::template
							  at<Index, List>;
