...
struct identity
{
	...
	// is equal:
		...
		>
		using s_char_judgment_is_equal = sf_judgment_is_equal
		<
			char, Value1, Value2, Continuation, Kind, ListKind
		>;
		...
		static constexpr bool (*p_char_judgment_is_equal)(char, char) =
			p_judgment_is_equal<char>;
};
