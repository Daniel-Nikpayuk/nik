...
struct identity
{
	...
	// is equal:
		...
		>
		using s_unsigned_long_judgment_is_equal = sf_judgment_is_equal
		<
			unsigned long, Value1, Value2, Continuation, Memoizer
		>;
		...
		static constexpr bool (*p_unsigned_long_judgment_is_equal)(unsigned long, unsigned long) =
			p_judgment_is_equal<unsigned long>;
};
