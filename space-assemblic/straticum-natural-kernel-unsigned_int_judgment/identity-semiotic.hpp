...
struct identity
{
	...
	// is equal:
		...
		>
		using s_unsigned_int_judgment_is_equal = sf_judgment_is_equal
		<
		...
		static constexpr bool (*p_unsigned_int_judgment_is_equal)(unsigned int, unsigned int) =
			p_judgment_is_equal<unsigned int>;
};
