...
struct identity
{
	...
	// :
		...
		>
		using s_is_judgment_stem = typename pattern_match_judgment_stem_<Type, Exp>::template
		s_match_induct
		<
		...
		<
			...
			typename Image = bool
		>
		static constexpr Image a_is_judgment_stem = pattern_match_judgment_stem_<Type, Exp>::template
		a_match_induct
		<
			Continuation, Image
		>;
