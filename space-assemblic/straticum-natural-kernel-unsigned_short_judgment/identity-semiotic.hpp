...
struct identity
{
	...
	// is equal:
		...
		>
		using s_unsigned_short_judgment_is_equal = sf_judgment_is_equal
		<
			unsigned short, Value1, Value2, Continuation, Memoizer
		>;
		...
		static constexpr bool (*p_unsigned_short_judgment_is_equal)(unsigned short, unsigned short) =
			p_judgment_is_equal<unsigned short>;
};
