...
struct filter
{
	...
	// :
		...
		>
		using s_char32_t_judgment_ = s_char32_t_judgment_<Exp, Continuation, Memoizer>;
		...
		<
			...
			typename Image
		>
		static constexpr Image a_char32_t_judgment_ = a_char32_t_judgment_<Exp, Continuation, Image>;
