...
struct identity
{
	...
	// is equal:
		...
		>
		using s_signed_char_judgment_is_equal = sf_judgment_is_equal
		<
			signed char, Value1, Value2, Continuation, Memoizer
		>;
		...
		static constexpr bool (*p_signed_char_judgment_is_equal)(signed char, signed char) =
			p_judgment_is_equal<signed char>;
};
