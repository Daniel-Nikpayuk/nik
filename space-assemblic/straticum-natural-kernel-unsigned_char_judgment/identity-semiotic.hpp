...
struct identity
{
	...
	// is equal:
		...
		>
		using s_unsigned_char_judgment_is_equal = sf_judgment_is_equal
		<
			unsigned char, Value1, Value2, Continuation, Memoizer
		>;
		...
		static constexpr bool (*p_unsigned_char_judgment_is_equal)(unsigned char, unsigned char) =
			p_judgment_is_equal<unsigned char>;
};
