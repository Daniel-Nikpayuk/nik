...
struct structure
{
	...
	// :
		...
		static constexpr void a_unsigned_char_judgment_ = a_unsigned_char_judgment_<Exp, Continuation>;

		// procedural:

		static constexpr void (*p_unsigned_char_judgment_)() = p_unsigned_char_judgment_<>;
};
