...
struct inductor
{
	...
	<
		...
		dependent_memoization<Type>::template af_values_list_length<Exp, ch_assemblic_value, size_type> == NIK_ONE	,
	...
	<
		dependent_memoization<Type>::template pattern_match_values_list<Exp>::template a_match_induct<>			&&
		dependent_memoization<Type>::template a_values_list_length<Exp, ch_assemblic_value, size_type> == NIK_ONE	&&
