...
struct identity
{
	...
	template<typename Exp, template<typename Kind, Kind> class Judgement, typename Continuation>
	...
	template<auto Exp, template<typename Kind, Kind> class Judgement, typename Continuation>
