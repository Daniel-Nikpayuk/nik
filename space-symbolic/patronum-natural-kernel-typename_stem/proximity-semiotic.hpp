...
struct proximity
{
	...
	// :
		...
		>
		using s_typename_stem_ = typename pattern_match_typename_stem_<Type, Exp>::template
		s_front_grow_induct
		<
			Continuation, filler
		>;
		...
		<
			...
			typename Image = bool
		>
		static constexpr Image a_typename_stem_ = pattern_match_typename_stem_<Type, Exp1>::template
