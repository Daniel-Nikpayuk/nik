...
namespace nik
{
	nik_begin_module(straticum, natural, kernel, signed_long_judgment, symbolic, semiotic)
...
//		#include"filter-semiotic.hpp"
	...
	nik_end_module(straticum, natural, kernel, signed_long_judgment, symbolic, semiotic)
}
