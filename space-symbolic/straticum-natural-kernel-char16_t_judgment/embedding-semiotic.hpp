...
struct embedding
{
	...
	// value:
		...
		<
			...
			Kind (*Op)(char16_t) = p_identity<Kind>
		>
		using s_char16_t_judgment_value = s_judgment_value
		<
			char16_t, Judgment, Continuation, Kind, ListKind, Op
		>;
		...
		<
			char16_t, Judgment, Continuation, Kind, ListKind, Op, Image
		>;
	...
	// curried value:
		...
		<
			...
			Kind (*Op)(char16_t) = p_identity<Kind>
		>
		using s_curried_char16_t_judgment_value = s_curried_judgment_value
		<
			char16_t, Judgment, Continuation, Kind, Op
		>;
		...
		<
			char16_t, Judgment, Continuation, Kind, Op, Image
		>;
};
