...
#ifndef CONTEXT_SEMIOTIC_ITERATOR_VECTOR_H
#define CONTEXT_SEMIOTIC_ITERATOR_VECTOR_H
...
*/
			...
			static typename Vector::iterator shift_left(Vector & v,
				typename Vector::const_iterator in, typename Vector::const_iterator end, typename Vector::size_type length)
					{ return bidirectional_iterator::assign(const_cast<typename Vector::iterator>(in)-length, in, end); }
...
*/
			...
			static typename Vector::iterator shift_right(Vector & v,
				typename Vector::const_iterator in, typename Vector::const_iterator end, typename Vector::size_type length)
			{ return bidirectional_iterator::reverse_assign(const_cast<typename Vector::iterator>(end)+length-1, end-1, in-1); }
