...
/*************** Recode to adhere to semiotic unsafe but clean standards; is it worth building a half_register iterator? **********/
/// for efficiency it's not worth building an iterator, but this code can still be cleaned with a better design.
/// it might be worth building a template iterator as the control flow would be done during compile time.
