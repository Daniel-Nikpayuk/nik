...
#ifndef CONTEXT_SEMIOTIC_ITERATOR_EXTENSIONWISE_MACRO_H
#define CONTEXT_SEMIOTIC_ITERATOR_EXTENSIONWISE_MACRO_H
...
static void no_return(WPointer out, size_type n, ValueType value) \
{ \
	while (n) \
	{ \
		out=dir(out)=WPointer::new_pointer(); \
		(*out)op(value); \
		--n; \
	} \
}
