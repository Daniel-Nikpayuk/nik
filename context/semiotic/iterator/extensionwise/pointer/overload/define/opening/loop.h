...
template<typename Node, typename WNode, typename WPointer, typename EWPointer> \
static rtn label##_return(WPointer out, EWPointer end, size_type in) \
{ \
	while (out != end) \
	{ \
		*out=new Node[in]; \
...
#define opening_loop_with_return_delete_brackets_0(dir, inv)		_opening_loop_delete_0(dir, inv, [], with, WPointer, return out;)
