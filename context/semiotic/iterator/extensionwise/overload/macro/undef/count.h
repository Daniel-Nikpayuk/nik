...
#ifndef NIK_CONTEXT_SEMIOTIC_ITERATOR_EXTENSIONWISE_OVERLOAD_MACRO_UNDEF_COUNT_H
#define NIK_CONTEXT_SEMIOTIC_ITERATOR_EXTENSIONWISE_OVERLOAD_MACRO_UNDEF_COUNT_H

#undef count_no_return_0
#undef count_with_return_0
#undef count_no_return_left_0
#undef count_with_return_left_0
...
#undef count_no_return_bracket_2
#undef count_with_return_bracket_2
