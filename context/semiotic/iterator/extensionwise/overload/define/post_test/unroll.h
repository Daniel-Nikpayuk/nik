...
#define post_test_unroll_no_return_0(method, dir, inv, op) \
...
#define post_test_unroll_with_return_0(method, dir, inv, op) \
template<typename WNode, typename WPointer, typename ValueType> \
...
#define post_test_unroll_no_return_left_0(method, dir, inv, op) \
...
#define post_test_unroll_with_return_left_0(method, dir, inv, op) \
template<typename WNode, typename WPointer> \
...
#define post_test_unroll_no_return_right_0(method, dir, inv, op) \
template<typename WNode, typename WPointer> \
static void no_return(WPointer out) \
{ \
	out=dir(out)=new WNode; \
...
#define post_test_unroll_with_return_right_0(method, dir, inv, op) \
template<typename WNode, typename WPointer> \
static WPointer with_return(WPointer out) \
{ \
	out=dir(out)=new WNode; \
...
#define post_test_unroll_no_return_new_0(method, dir, inv) \
...
#define post_test_unroll_with_return_new_0(method, dir, inv) \
template<typename Node, typename WNode, typename WPointer> \
static WPointer with_return(WPointer out) \
{ \
	out=dir(out)=new WNode; \
...
#define post_test_unroll_no_return_delete_0(method, dir, inv) \
template<typename WNode, typename WPointer> \
static void no_return(WPointer out) \
{ \
...
#define post_test_unroll_with_return_delete_0(method, dir, inv) \
template<typename WNode, typename WPointer> \
static WPointer with_return(WPointer out) \
{ \
	WPointer current=out; \
...
#define post_test_unroll_no_return_new_brackets_0(method, dir, inv) \
template<typename Node, typename WNode, typename WPointer> \
...
#define post_test_unroll_with_return_new_brackets_0(method, dir, inv) \
template<typename Node, typename WNode, typename WPointer> \
...
#define post_test_unroll_no_return_delete_brackets_0(method, dir, inv) \
template<typename WNode, typename WPointer> \
static void no_return(WPointer out) \
{ \
	WPointer current=out; \
...
#define post_test_unroll_with_return_delete_brackets_0(method, dir, inv) \
template<typename WNode, typename WPointer> \
static WPointer with_return(WPointer out) \
{ \
	WPointer current=out; \
...
*/
#define post_test_unroll_no_return_1(method, dir, inv, op) \
...
*/
#define post_test_unroll_with_return_1(method, dir, inv, op) \
template<typename WNode, typename WPointer, typename RIterator> \
...
/*
	...
	2. If you have interest in the final out value, but have no interest in a return,
		call this macro with WPointer as reference (assuming referencing is preferred).
*/
#define post_test_unroll_no_return_right_1(method, dir, inv, op, r) \
template<typename WNode, typename WPointer, typename RIterator> \
static void no_return(WPointer out, RIterator in) \
{ \
	dir##dir(in); \
...
/*
	...
	2. If you have an interest in the final out value, and you do want to reference,
		but in addition you still require a return value, call this macro.
*/
#define post_test_unroll_with_return_right_1(method, dir, inv, op, r) \
template<typename WNode, typename WPointer, typename RIterator> \
static WPointer with_return(WPointer out, RIterator in) \
{ \
	dir##dir(in); \
...
#define post_test_unroll_no_return_new_brackets_1(method, dir, inv) \
...
#define post_test_unroll_with_return_new_brackets_1(method, dir, inv) \
template<typename Node, typename WNode, typename WPointer, typename RPointer> \
...
/*
	...
	2. If you have interest in the final out value, but have no interest in a return,
		call this macro with WPointer as reference (assuming referencing is preferred).
*/
#define post_test_unroll_no_return_2(method, dir, inv, op) \
...
/*
	...
	2. If you have an interest in the final out value, and you do want to reference,
		but in addition you still require a return value, call this macro.
*/
#define post_test_unroll_with_return_2(method, dir, inv, op) \
template<typename WNode, typename WPointer, typename RIterator1, typename RIterator2> \
...
/*
	...
	2. If you have interest in the final out value, but have no interest in a return,
		call this macro with WPointer as reference (assuming referencing is preferred).
*/
#define post_test_unroll_no_return_brackets_2(method, dir, inv, op) \
template<typename WNode, typename WPointer, typename RIterator1, typename RIterator2> \
static void no_return(WPointer out, RIterator1 in1, RIterator2 in2) \
{ \
	dir##dir(in1); dir##dir(in2); \
...
/*
	...
	2. If you have an interest in the final out value, and you do want to reference,
		but in addition you still require a return value, call this macro.
*/
#define post_test_unroll_with_return_brackets_2(method, dir, inv, op) \
template<typename WNode, typename WPointer, typename RIterator1, typename RIterator2> \
static WPointer with_return(WPointer out, RIterator1 in1, RIterator2 in2) \
{ \
	dir##dir(in1); dir##dir(in2); \
