...
#ifndef NIK_CONTEXT_SEMIOTIC_ITERATOR_OVERLOAD_BACKWARD_H
#define NIK_CONTEXT_SEMIOTIC_ITERATOR_OVERLOAD_BACKWARD_H
...
*/
	struct brackets
	{
		...
		struct count
		{
			count_no_return_bracket_2(-, )
			count_with_return_bracket_2(-, )
		};
	};
/*
