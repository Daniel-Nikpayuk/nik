...
#ifndef NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_CHAIN_IDENTITY_H
#define NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_CHAIN_IDENTITY_H
  ...
  namespace media
  {
   namespace iterator
   {
	...
	struct identity
	{
		...
		typedef semiotic::iterator::expansionwise::pointer::policy<size_type> sipp_policy;
		typedef semiotic::iterator::expansionwise::list::policy<size_type> sipc_policy;
