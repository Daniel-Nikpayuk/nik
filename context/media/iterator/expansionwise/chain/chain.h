...
#ifndef NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_CHAIN_H
#define NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_CHAIN_H
...
*/
		...
		template<typename RIterator, typename Chain>
		static typename Chain::iterator insert(Chain & l,
			typename Chain::const_iterator it, RIterator first, RIterator last)
		{
