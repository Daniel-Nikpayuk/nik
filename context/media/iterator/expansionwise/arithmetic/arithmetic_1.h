...
#ifndef NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_ARITHMETIC_1_H
#define NIK_CONTEXT_MEDIA_ITERATOR_EXPANSIONWISE_ARITHMETIC_1_H
...
*/
			...
			{
				carry=0;
				s_expa_policy::fwd_arit::scale::no_return(carry, out, in1, end1, in2);
			}
			...
			static void no_return(WIterator out, RIterator in1, ERIterator end1, ValueType in2)
				{ s_expa_policy::fwd_arit::scale::no_return((ValueType) 0, out, in1, end1, in2); }
/*
	carry is the overhead value. Set this to zero for the "normal" interpretation.
	out is the resultant containing structure.
	in1 is the initial containing structure.
...
*/
			...
			{
				carry=0;
				return s_expa_policy::fwd_arit::scale::with_return(carry, out, in1, end1, in2);
			}

			template<typename ValueType, typename WIterator, typename RIterator, typename ERIterator>
			static WIterator with_return(WIterator out, RIterator in1, ERIterator end1, ValueType in2)
				{ return s_expa_policy::fwd_arit::scale::with_return((ValueType) 0, out, in1, end1, in2); }
		};
...
*/
				...
				{
					carry=0;
					s_expa_policy::fwd_arit::assign::scale::no_return(carry, out, end, in);
				}
				...
				static void no_return(WIterator out, EIterator end, ValueType in)
					{ s_expa_policy::fwd_arit::assign::scale::no_return((ValueType) 0, out, end, in); }
			};
		};
/*
	unroll:
...
*/
				...
				{
					carry=0;
					s_expa_policy::fwd_arit::scale::no_return(carry, out, in1, in2);
				}
				...
				static void no_return(WIterator out, RIterator in1, ValueType in2)
					{ s_expa_policy::fwd_arit::scale::no_return((ValueType) 0, out, in1, in2); }
/*
	carry is the overhead value. Set this to zero for the "normal" interpretation.
	out is the resultant containing structure.
	in1 is the initial containing structure.
...
*/
				...
				{
					carry=0;
					return s_expa_policy::fwd_arit::scale::with_return(carry, out, in1, in2);
				}

				template<typename ValueType, typename WIterator, typename RIterator>
				static WIterator with_return(WIterator out, RIterator in1, ValueType in2)
					{ return s_expa_policy::fwd_arit::scale::with_return((ValueType) 0, out, in1, in2); }
			};
...
*/
					...
					{
						carry=0;
						s_expa_policy::fwd_arit::assign::scale::no_return(carry, out, in);
					}

					template<typename ValueType, typename WIterator>
					static void no_return(WIterator out, ValueType in)
						{ s_expa_policy::fwd_arit::assign::scale::no_return((ValueType) 0, out, in); }
/*
	carry is the overhead value. Set this to zero for the "normal" interpretation.
	out is the resultant containing structure.
	in1 is the initial containing structure.
...
*/
					...
					{
						carry=0;
						return s_expa_policy::fwd_arit::assign::scale::with_return(carry, out, in);
					}

					template<typename ValueType, typename WIterator>
					static WIterator with_return(WIterator out, ValueType in)
						{ return s_expa_policy::fwd_arit::assign::scale::with_return((ValueType) 0, out, in); }
				};
			};
		};
	};
...
*/
			struct half_digit
			{
				...
				{
					r=*n;
					s_expa_policy::bwd_arit::divide::half_digit::no_return((ValueType) 0, r, q, --n, end, d);
				}
				...
				{
					r=*n;
					return s_expa_policy::bwd_arit::divide::half_digit::with_return((ValueType) 0, r, q, --n, end, d);
				}
...
*/
			struct single_digit
			{
				...
				{
					r=*n;
					s_expa_policy::bwd_arit::divide::single_digit::no_return((ValueType) 0, r, q, --n, end, d);
				}
				...
				{
					r=*n;
					return s_expa_policy::bwd_arit::divide::single_digit::with_return((ValueType) 0, r, q, --n, end, d);
				}
...
*/
				struct half
				{
					...
					{
						r=*n;
						s_expa_policy::bwd_arit::divide::single_digit::half::no_return(r, q, --n, end, d);
					}
					...
					{
						r=*n;
						return s_expa_policy::bwd_arit::divide::single_digit::half::with_return(r, q, --n, end, d);
					}
...
*/
				struct half_digit
				{
					...
					{
						r=*n;
						s_expa_policy::bwd_arit::divide::half_digit::no_return((ValueType) 0, r, q, --n, d);
					}
					...
					{
						r=*n;
						return s_expa_policy::bwd_arit::divide::half_digit::with_return((ValueType) 0, r, q, --n, d);
					}
...
*/
				struct single_digit
				{
					...
					{
						r=*n;
						s_expa_policy::bwd_arit::divide::single_digit::no_return((ValueType) 0, r, q, --n, d);
					}
					...
					{
						r=*n;
						return s_expa_policy::bwd_arit::divide::single_digit::with_return((ValueType) 0, r, q, --n, d);
					}
...
*/
					struct half
					{
						...
						{
							r=*n;
							s_expa_policy::bwd_arit::divide::single_digit::half::no_return(r, q, --n, d);
						}
						...
						{
							r=*n;
							return s_expa_policy::bwd_arit::divide::single_digit::half::with_return(r, q, --n, d);
						}
...
*/
				...
				RIterator1 in1, ERIterator1 end1, RIterator2 in2, ERIterator2 end2)
			{
				...
				s_expa_policy::bid_arit::multiply::no_return(out, out1, out1, in1, end1, in2, end2);
			}
...
*/
				...
				{
					s_expa_policy::fwd_comp::repeat::no_return(out, end, (ValueType) 0);
					s_expa_policy::bid_arit::multiply::half::no_return(out, out1, out1, in1, end1, in2, end2);
				}
			};
		};
...
*/
				...
				{
					s_expa_policy::fwd_comp::assign::no_return(out2, out, end);
					s_expa_policy::fwd_comp::repeat::no_return(out, end, (ValueType) 0);
					s_expa_policy::bid_arit::assign::multiply::no_return(out, out1, out1, out2, end2, in1, end1);
				}
...
*/
						...
						WIterator1 out2, EWIterator2 end2, RIterator1 in1, ERIterator1 end1)
					{
						s_expa_policy::fwd_comp::assign::no_return(out2, out, end);
						s_expa_policy::fwd_comp::repeat::no_return(out, end, (ValueType) 0);
						s_expa_policy::bid_arit::assign::multiply::half::no_return(out, out1, out1, out2, end2, in1, end1);
					}
				};
			};
		};
...
*/
				...
				{
					RIterator2 ld=s_expa_policy::bwd_arit::zero::with_break(dend-1, d);
					...
					s_expa_policy::rnd_arit::divide::multiple_digit::no_return(r, lr, rend, q, t, tend, n, nend, d, ld, dend);
...
*/
					...
					{
						s_expa_policy::rnd_arit::divide::multiple_digit::half::
...
*/
					...
					{
						s_expa_policy::rnd_arit::divide::multiple_digit::no_return(r, lr, q, t, n, d, ld);
					}
...
*/
						...
						static void no_return(WIterator1 r, WIterator1 lr,
							WIterator2 q, WIterator3 t, RIterator1 n, RIterator2 d, RIterator2 ld)
						{
							s_expa_policy::rnd_arit::divide::multiple_digit::half::no_return(r, lr, q, t, n, d, ld);
						}
					};
				};
			};
