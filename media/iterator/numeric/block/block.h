...
*/
				...
				class _block : protected semiotic::iterator::block<SizeType, SizeType, BlockSize>
				{
					protected:
						...
						typedef typename generic::fwd_arit_subroll<SizeType, BlockSize, BlockSize> fwd_arit_subroll;
						friend fwd_arit;
					...
					public:
						...
						{
							*block::array=n;
							fwd_recu_decroll::repeat(block::array+1, 0);
						}
					...
					public:
						bool operator == (const _block & b) const
							{ return fwd_arit_unroll::equal(block::array, b.array); }
						bool operator != (const _block & b) const
							{ return fwd_arit_unroll::not_equal(block::array, b.array); }
						bool operator < (const _block & b) const
					...
					public:
						...
						{
							_block out(*this);
							if (m > BlockSize) fwd_recu_unroll::repeat(out.array, 0);
							else bdl_arit::left_shift_assign(out.array, BlockSize, m);
							return out;
						}
						...
						_block operator >> (size_type m) const
						{
							_block out(*this);
							if (m > BlockSize) fwd_recu_unroll::repeat(out.array, 0);
							else bdl_arit::right_shift_assign(out.array, BlockSize, m);
							return out;
						}
					public:
						...
						{
							_block out;
							fwd_arit_unroll::plus(out.array, block::array, b.array, 0);
							return out;
						}
						...
						{
							_block out;
							fwd_arit_unroll::scale(out.array, block::array, b, (size_type) 0);
							return out;
						}
						...
						_block operator * (const _block & b) const
						{
							...
							fwd_arit_subroll::asterisk(out.array, tmp.array, block::array, b.array);
							return out;
						}
				};
			}
