...
#ifndef NIK_MEDIA_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_OVERLOAD_H
#define NIK_MEDIA_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_FUNCTIONAL_OVERLOAD_H
  ...
  namespace numeric
  {
   namespace random_access
   {
	...
	struct overload
	{
		...
		#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/define/loop_count.h"

		template<size_type N, size_type M=0, size_type L=0>
		struct unroll
		{
			#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/define/unroll.h"
		};

		template<size_type M, size_type L>
		struct unroll<0, M, L>
		{
			#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/define/initial.h"
		};
...
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/open/initial.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/open/unroll.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/open/count.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/open/loop.h"

#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/opening/initial.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/opening/unroll.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/opening/count.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/opening/loop.h"

#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closing/initial.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closing/unroll.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closing/count.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closing/loop.h"

#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closed/initial.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closed/unroll.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closed/count.h"
#include"../../../../../../../semiotic/numeric/random_access/iterator/macro/undef/closed/loop.h"
