...
#define _closing_initial_0(dir, inv, op, label, rtn, stmt) \
...
#define _closing_initial_lr_0(dir, inv, label, rtn, stmt, lp, rp) \
template<typename WNode, typename WPointer> \
static rtn label##_return(WPointer out) \
	{ stmt }

#define closing_initial_no_return_left_0(dir, inv, op)			_closing_initial_lr_0(dir, inv, no, void, , op, )
#define closing_initial_with_return_left_0(dir, inv, op)		_closing_initial_lr_0(dir, inv, with, WPointer, return out;, op, )
...
#define _closing_initial_new_0(dir, inv, label, rtn, stmt) \
...
#define _closing_initial_new_brackets_0(dir, inv, label, rtn, stmt) \
template<typename Node, typename WNode, typename WPointer> \
...
#define _closing_initial_delete_0(dir, inv, op, label, rtn, stmt) \
template<typename WNode, typename WPointer> \
static rtn label##_return(WPointer out) \
	{ stmt }

#define closing_initial_no_return_delete_0(dir, inv)			_closing_initial_delete_0(dir, inv, , no, void, )
#define closing_initial_with_return_delete_0(dir, inv)			_closing_initial_delete_0(dir, inv, , with, WPointer, return out;)
...
#define _closing_initial_lr_1(dir, inv, op, label, rtn, stmt, lp, rp) \
template<typename WNode, typename WPointer, typename RIterator> \
static rtn label##_return(WPointer out, RIterator in) \
	{ stmt }

#define closing_initial_no_return_1(dir, inv, op)			_closing_initial_lr_1(dir, inv, op, no, void, , , )
#define closing_initial_with_return_1(dir, inv, op)			_closing_initial_lr_1(dir, inv, op, with, WPointer, return out;, , )
...
#define _closing_initial_new_brackets_1(dir, inv, label, rtn, stmt) \
...
#define _closing_initial_2(dir, inv, op, label, rtn, stmt) \
...
#define _closing_initial_brackets_2(dir, inv, op, label, rtn, stmt) \
template<typename WNode, typename WPointer, typename RIterator1, typename RIterator2> \
static rtn label##_return(WPointer out, RIterator1 in1, RIterator2 in2) \
	{ stmt }

#define closing_initial_no_return_brackets_2(dir, inv, op)		_closing_initial_brackets_2(dir, inv, op, no, void, )
#define closing_initial_with_return_brackets_2(dir, inv, op)		_closing_initial_brackets_2(dir, inv, op, with, WPointer, return out;)
