...
/************************************************************************************************************************/
	...
	#define interval_unary_mutate_mutate(label, out_pointer, in_pointer, return_policy, count_policy)				\
		interval_unary_mutate_mutate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define interval_unary_mutate_deallocate(label, out_pointer, in_pointer, return_policy, count_policy)				\
		interval_unary_mutate_deallocate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define interval_unary_allocate_mutate(label, out_pointer, in_pointer, return_policy, count_policy)				\
		interval_unary_allocate_mutate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define interval_unary_allocate_deallocate(label, out_pointer, in_pointer, return_policy, count_policy)				\
		interval_unary_allocate_deallocate_##count_policy(label, out_pointer, in_pointer, return_policy)


#define interval_unary(label, out_memory, out_pointer, in_memory, in_pointer, return_policy, count_policy)				\
	interval_unary_##out_memory##_##in_memory(label, out_pointer, in_pointer, return_policy, count_policy)


#define function_type_interval(label, out_memory, out_pointer, in_memory, in_pointer, arity_policy, return_policy, count_policy)	\
	interval_##arity_policy(label, out_memory, out_pointer, in_memory, in_pointer, return_policy, count_policy)
...
/************************************************************************************************************************/
	...
	#define functor_interval_unary_mutate_mutate(label, out_pointer, in_pointer, return_policy, count_policy)			\
		functor_interval_unary_mutate_mutate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define functor_interval_unary_mutate_deallocate(label, out_pointer, in_pointer, return_policy, count_policy)			\
		functor_interval_unary_mutate_deallocate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define functor_interval_unary_allocate_mutate(label, out_pointer, in_pointer, return_policy, count_policy)			\
		functor_interval_unary_allocate_mutate_##count_policy(label, out_pointer, in_pointer, return_policy)

	#define functor_interval_unary_allocate_deallocate(label, out_pointer, in_pointer, return_policy, count_policy)			\
		functor_interval_unary_allocate_deallocate_##count_policy(label, out_pointer, in_pointer, return_policy)


#define functor_interval_unary(label, out_memory, out_pointer, in_memory, in_pointer, return_policy, count_policy)			\
	functor_interval_unary_##out_memory##_##in_memory(label, out_pointer, in_pointer, return_policy, count_policy)


#define function_type_functor_interval(label, out_memory, out_pointer, in_memory, in_pointer, arity_policy, return_policy, count_policy) \
	functor_interval_##arity_policy(label, out_memory, out_pointer, in_memory, in_pointer, return_policy, count_policy)
...
#define function_type(label, operator_policy, out_memory, out_pointer, in_memroy, in_pointer, arity_policy, return_policy, count_policy) \
	function_type_##operator_policy(label, out_memory, out_pointer, in_memory, in_pointer, arity_policy, return_policy, count_policy)
