...
struct reverse
{
	...
	struct name \
	{ \
		name##_loop_no_return_reverse(SGN, INV) \
		name##_loop_with_return_reverse(SGN, INV) \
 \
		struct count \
		{ \
			name##_count_no_return_reverse(SGN, INV) \
			name##_count_with_return_reverse(SGN, INV) \
		}; \
	};
...
struct assign
{
	struct reverse
	{
		...
		struct name \
		{ \
			name##_loop_no_return_assign_reverse(SGN, INV) \
			name##_loop_with_return_assign_reverse(SGN, INV) \
 \
			struct count \
			{ \
				name##_count_no_return_assign_reverse(SGN, INV) \
				name##_count_with_return_assign_reverse(SGN, INV) \
			}; \
		};
