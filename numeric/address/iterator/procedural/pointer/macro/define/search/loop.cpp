	...
	struct index
	{
		struct before
		{
			struct last
			{
				...
				struct name \
				{ \
					name##_loop_no_return_find_index_before_last(SGN, INV) \
					name##_loop_with_return_find_index_before_last(SGN, INV) \
 \
					struct count \
					{ \
						name##_count_no_return_find_index_before_last(SGN, INV) \
						name##_count_with_return_find_index_before_last(SGN, INV) \
					}; \
				};
			...
			struct end
			{
				...
				struct name \
				{ \
					name##_loop_no_return_find_index_before_end(SGN, INV) \
					name##_loop_with_return_find_index_before_end(SGN, INV) \
 \
					struct count \
					{ \
						name##_count_no_return_find_index_before_end(SGN, INV) \
						name##_count_with_return_find_index_before_end(SGN, INV) \
					}; \
				};
