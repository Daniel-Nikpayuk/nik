...
#define _open_loop_catenate(dir, inv, label, rtn, stmt) \
...
#define _open_loop_with_closing_catenate(dir, inv, label, rtn, stmt) \
template<typename WPointer, typename EWPointer, typename RPointer> \
static rtn label##_return(WPointer out, EWPointer end, RPointer in) \
{ \
	out=search::find::index::before::end::with_return(out, end); \
...
#define _open_loop_with_closed_catenate(dir, inv, label, rtn, stmt) \
template<typename WPointer, typename EWPointer, typename RPointer> \
static rtn label##_return(WPointer out, EWPointer end, RPointer in) \
{ \
	out=search::find::index::before::end::with_return(out, end); \
...
#define _open_loop_with_opening_catenate(dir, inv, label, rtn, stmt) \
template<typename WPointer, typename EWPointer, typename RPointer> \
static rtn label##_return(WPointer out, EWPointer end, RPointer in) \
{ \
	out=search::find::index::before::end::with_return(out, end); \
...
#define open_loop_no_return_with_open_catenate(dir, inv)		_open_loop_with_open_catenate(dir, inv, no, void, )
#define open_loop_with_return_with_open_catenate(dir, inv)		_open_loop_with_open_catenate(dir, inv, with, WPointer, return out;)
