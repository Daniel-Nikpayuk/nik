...
#define declare_variables_forward()


#define declare_variables_backward()							WPointer current;
...
#define declare_variables(direction_policy)									\
	declare_variables_##direction_policy()
...
#define direction_policy(dir)								out=dir(out)=new WNode;


	#define forward()								direction_policy(+)


	#define backward()								current=out;			\
											out=new WNode;			\
											+out=current;
