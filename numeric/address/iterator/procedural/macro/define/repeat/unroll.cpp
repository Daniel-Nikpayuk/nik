...
struct plus
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(plus, SGN, INV, =+) \
		name##_unroll_with_return_1(plus, SGN, INV, =+) \
 \
		name##_unroll_no_return_2(plus, SGN, INV, +) \
		name##_unroll_with_return_2(plus, SGN, INV, +) \
	};
...
struct minus
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(minus, SGN, INV, =-) \
		name##_unroll_with_return_1(minus, SGN, INV, =-) \
 \
		name##_unroll_no_return_2(minus, SGN, INV, -) \
		name##_unroll_with_return_2(minus, SGN, INV, -) \
	};
...
struct asterisk
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(asterisk, SGN, INV, =*) \
		name##_unroll_with_return_1(asterisk, SGN, INV, =*) \
 \
		name##_unroll_no_return_2(asterisk, SGN, INV, *) \
		name##_unroll_with_return_2(asterisk, SGN, INV, *) \
	};
...
struct slash
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(slash, SGN, INV, /) \
		name##_unroll_with_return_2(slash, SGN, INV, /) \
	};
...
struct percent
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(percent, SGN, INV, %) \
		name##_unroll_with_return_2(percent, SGN, INV, %) \
	};
...
struct caret
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(caret, SGN, INV, ^) \
		name##_unroll_with_return_2(caret, SGN, INV, ^) \
	};
...
struct ampersand
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(ampersand, SGN, INV, =&) \
		name##_unroll_with_return_1(ampersand, SGN, INV, =&) \
 \
		name##_unroll_no_return_2(ampersand, SGN, INV, &) \
		name##_unroll_with_return_2(ampersand, SGN, INV, &) \
	};
...
struct bar
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(bar, SGN, INV, |) \
		name##_unroll_with_return_2(bar, SGN, INV, |) \
	};
...
struct tilde
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(tilde, SGN, INV, =~) \
		name##_unroll_with_return_1(tilde, SGN, INV, =~) \
	};
...
struct exclamation
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(exclamation, SGN, INV, =!) \
		name##_unroll_with_return_1(exclamation, SGN, INV, =!) \
	};
...
struct less_than
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(less_than, SGN, INV, <) \
		name##_unroll_with_return_2(less_than, SGN, INV, <) \
	};
...
struct greater_than
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(greater_than, SGN, INV, >) \
		name##_unroll_with_return_2(greater_than, SGN, INV, >) \
	};
...
struct left_shift
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(left_shift, SGN, INV, <<) \
		name##_unroll_with_return_2(left_shift, SGN, INV, <<) \
	};
...
struct right_shift
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(right_shift, SGN, INV, >>) \
		name##_unroll_with_return_2(right_shift, SGN, INV, >>) \
	};
...
struct equals
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(equals, SGN, INV, ==) \
		name##_unroll_with_return_2(equals, SGN, INV, ==) \
	};
...
struct not_equals
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(not_equals, SGN, INV, !=) \
		name##_unroll_with_return_2(not_equals, SGN, INV, !=) \
	};
...
struct less_than_or_equal
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(less_than_or_equal, SGN, INV, <=) \
		name##_unroll_with_return_2(less_than_or_equal, SGN, INV, <=) \
	};
...
struct greater_than_or_equal
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(greater_than_or_equal, SGN, INV, >=) \
		name##_unroll_with_return_2(greater_than_or_equal, SGN, INV, >=) \
	};
...
struct logical_and
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(logical_and, SGN, INV, &&) \
		name##_unroll_with_return_2(logical_and, SGN, INV, &&) \
	};
...
struct logical_or
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(logical_or, SGN, INV, ||) \
		name##_unroll_with_return_2(logical_or, SGN, INV, ||) \
	};
...
struct left_increment
{
	...
	struct name \
	{ \
		name##_unroll_no_return_left_0(left_increment, SGN, INV, ++) \
	};
...
struct right_increment
{
	...
	struct name \
	{ \
		name##_unroll_no_return_right_0(right_increment, SGN, INV, ++) \
	};
...
struct left_decrement
{
	...
	struct name \
	{ \
		name##_unroll_no_return_left_0(left_decrement, SGN, INV, --) \
	};
...
struct right_decrement
{
	...
	struct name \
	{ \
		name##_unroll_no_return_right_0(right_decrement, SGN, INV, --) \
	};
...
struct point_asterisk
{
	...
	struct name \
	{ \
		name##_unroll_no_return_2(point_asterisk, SGN, INV, ->*) \
		name##_unroll_with_return_2(point_asterisk, SGN, INV, ->*) \
	};
...
struct point
{
	...
	struct name \
	{ \
		name##_unroll_with_return_2(point, SGN, INV, .operator->) \
	};
...
struct parentheses
{
	...
	struct name \
	{ \
		name##_unroll_no_return_right_0(parentheses, SGN, INV, ()) \
 \
		name##_unroll_no_return_right_1(parentheses, SGN, INV, =, ()) \
		name##_unroll_with_return_right_1(parentheses, SGN, INV, =, ()) \
 \
		name##_unroll_no_return_2(parentheses, SGN, INV, ) \
		name##_unroll_with_return_2(parentheses, SGN, INV, ) \
	};
...
struct brackets
{
	...
	struct name \
	{ \
		name##_unroll_no_return_brackets_2(brackets, SGN, INV, ) \
		name##_unroll_with_return_brackets_2(brackets, SGN, INV, ) \
	};
...
struct repeat
{
	...
	struct name \
	{ \
		name##_unroll_no_return_0(repeat, SGN, INV, =) \
		name##_unroll_with_return_0(repeat, SGN, INV, =) \
	};
...
*/
	struct plus
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(plus, SGN, INV, +=) \
		};
...
*/
	struct minus
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(minus, SGN, INV, -=) \
		};
...
*/
	struct asterisk
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(asterisk, SGN, INV, *=) \
		};
...
*/
	struct slash
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(slash, SGN, INV, /=) \
		};
...
*/
	struct percent
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(percent, SGN, INV, %=) \
		};
...
*/
	struct caret
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(caret, SGN, INV, ^=) \
		};
...
*/
	struct ampersand
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(ampersand, SGN, INV, &=) \
		};
...
*/
	struct bar
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(bar, SGN, INV, |=) \
		};
...
*/
	struct right_shift
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(right_shift, SGN, INV, >>=) \
		};
...
*/
	struct left_shift
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_0(left_shift, SGN, INV, <<=) \
		};
...
struct assign
{
	...
	struct name \
	{ \
		name##_unroll_no_return_1(assign, SGN, INV, =) \
		name##_unroll_with_return_1(assign, SGN, INV, =) \
	};
...
*/
	struct slash
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(slash, SGN, INV, /=) \
			name##_unroll_with_return_1(slash, SGN, INV, /=) \
		};
...
*/
	struct percent
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(percent, SGN, INV, %=) \
			name##_unroll_with_return_1(percent, SGN, INV, %=) \
		};
...
*/
	struct caret
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(caret, SGN, INV, ^=) \
			name##_unroll_with_return_1(caret, SGN, INV, ^=) \
		};
...
*/
	struct bar
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(bar, SGN, INV, |=) \
			name##_unroll_with_return_1(bar, SGN, INV, |=) \
		};
...
*/
	struct right_shift
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(right_shift, SGN, INV, >>=) \
			name##_unroll_with_return_1(right_shift, SGN, INV, >>=) \
		};
...
*/
	struct left_shift
	{
		...
		struct name \
		{ \
			name##_unroll_no_return_1(left_shift, SGN, INV, <<=) \
			name##_unroll_with_return_1(left_shift, SGN, INV, <<=) \
		};
...
struct allocate
{
	...
	struct name \
	{ \
		name##_unroll_no_return_new_0(allocate, SGN, INV) \
		name##_unroll_with_return_new_0(allocate, SGN, INV) \
 \
		struct brackets \
		{ \
			name##_unroll_no_return_new_brackets_0(allocate, SGN, INV) \
			name##_unroll_with_return_new_brackets_0(allocate, SGN, INV) \
 \
			name##_unroll_no_return_new_brackets_1(allocate, SGN, INV) \
			name##_unroll_with_return_new_brackets_1(allocate, SGN, INV) \
		}; \
	};
...
struct deallocate
{
	...
	struct name \
	{ \
		name##_unroll_no_return_delete_0(deallocate, SGN, INV) \
		name##_unroll_with_return_delete_0(deallocate, SGN, INV) \
 \
		struct brackets \
		{ \
			name##_unroll_no_return_delete_brackets_0(deallocate, SGN, INV) \
			name##_unroll_with_return_delete_brackets_0(deallocate, SGN, INV) \
		}; \
	};
