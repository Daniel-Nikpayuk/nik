	...
	struct index
	{
		struct before
		{
			struct last
			{
				...
				struct name \
				{ \
					name##_unroll_no_return_find_index_before_last(SGN, INV) \
					name##_unroll_with_return_find_index_before_last(SGN, INV) \
				};
			...
			struct end
			{
				...
				struct name \
				{ \
					name##_unroll_no_return_find_index_before_end(SGN, INV) \
					name##_unroll_with_return_find_index_before_end(SGN, INV) \
				};
