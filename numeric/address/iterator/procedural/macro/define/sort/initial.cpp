...
struct reverse
{
	...
	struct name \
	{ \
		name##_initial_no_return_reverse(SGN, INV) \
		name##_initial_with_return_reverse(SGN, INV) \
	};
...
struct assign
{
	struct reverse
	{
		...
		struct name \
		{ \
			name##_initial_no_return_assign_reverse(SGN, INV) \
			name##_initial_with_return_assign_reverse(SGN, INV) \
		};
