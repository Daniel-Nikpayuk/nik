...
struct close
{
	struct left
	{
		...
		struct name \
		{ \
			name##_initial_no_return_close_left(SGN, INV) \
			name##_initial_with_return_close_left(SGN, INV) \
		};
	...
	struct right
	{
		...
		struct name \
		{ \
			name##_initial_no_return_close_right(SGN, INV) \
			name##_initial_with_return_close_right(SGN, INV) \
		};
...
struct open
{
	struct left
	{
		...
		struct name \
		{ \
			name##_initial_no_return_open_left(SGN, INV) \
			name##_initial_with_return_open_left(SGN, INV) \
		};
	...
	struct right
	{
		...
		struct name \
		{ \
			name##_initial_no_return_open_right(SGN, INV) \
			name##_initial_with_return_open_right(SGN, INV) \
		};
...
struct assign
{
	...
	{ \
		...
		{ \
			struct closing \
			{ \
				name##_initial_no_return_assign_as_closing(SGN, INV) \
				name##_initial_with_return_assign_as_closing(SGN, INV) \
			}; \
 \
			struct closed \
			{ \
				name##_initial_no_return_assign_as_closed(SGN, INV) \
				name##_initial_with_return_assign_as_closed(SGN, INV) \
			}; \
 \
			struct opening \
			{ \
				name##_initial_no_return_assign_as_opening(SGN, INV) \
				name##_initial_with_return_assign_as_opening(SGN, INV) \
			}; \
 \
			struct open \
			{ \
				name##_initial_no_return_assign_as_open(SGN, INV) \
				name##_initial_with_return_assign_as_open(SGN, INV) \
			}; \
		}; \
	};
...
struct catenate
{
	...
	{ \
		...
		{ \
			struct closing \
			{ \
				name##_initial_no_return_catenate_with_closing(SGN, INV) \
				name##_initial_with_return_catenate_with_closing(SGN, INV) \
			}; \
 \
			struct closed \
			{ \
				name##_initial_no_return_catenate_with_closed(SGN, INV) \
				name##_initial_with_return_catenate_with_closed(SGN, INV) \
			}; \
 \
			struct opening \
			{ \
				name##_initial_no_return_catenate_with_opening(SGN, INV) \
				name##_initial_with_return_catenate_with_opening(SGN, INV) \
			}; \
 \
			struct open \
			{ \
				name##_initial_no_return_catenate_with_open(SGN, INV) \
				name##_initial_with_return_catenate_with_open(SGN, INV) \
			}; \
		}; \
	};
