...
struct pop
{
	struct left
	{
		...
		struct name \
		{ \
			name##_loop_no_return_pop_left(SGN, INV) \
			name##_loop_with_return_pop_left(SGN, INV) \
 \
			struct count \
			{ \
				name##_count_no_return_pop_left(SGN, INV) \
				name##_count_with_return_pop_left(SGN, INV) \
			}; \
		};
