...
#define _open_count_find_index_before_last(dir, inv, label, rtn, stmt) \
...
#define _open_count_find_index_before_end(dir, inv, label, rtn, stmt) \
template<typename WPointer, typename ERPointer> \
static rtn label##_return(size_type & count, WPointer out, ERPointer end) \
{ \
	while (dir(out) != end) \
...
#define open_count_no_return_find_index_before_end(dir, inv)		_open_count_find_index_before_end(dir, inv, no, void, )
#define open_count_with_return_find_index_before_end(dir, inv)	_open_count_find_index_before_end(dir, inv, with, WPointer, return out;)
