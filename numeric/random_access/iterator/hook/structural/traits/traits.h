...
#ifndef NIK_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_STRUCTURAL_TRAITS_H
#define NIK_NUMERIC_RANDOM_ACCESS_ITERATOR_EXTENSIONWISE_STRUCTURAL_TRAITS_H
...
/*
	hook:
*/
		using hook=structural::hook<size_type>;
	};
     }
    }
   }
