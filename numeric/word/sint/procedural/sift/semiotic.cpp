...
struct sift
{
	...
	*/
	...
	struct high
	{
		static size_type with_return(size_type x, size_type s)
			{ return semiotic::over::right_shift::with_return(x, s); }
	...
	struct band
	{
		static size_type with_return(size_type x, size_type s, size_type t)
			{ return semiotic::over::right_shift::with_return(x & (1 << t) - 1, s); }
	};
	...
	*/
		static size_type signed_return(size_type primary)
		{
			...
			while (primary)
			{
				primary = semiotic::over::right_shift::with_return(primary, 1);
				++count;
			}
