...
struct functor
{
	...
	#include nik_typedef(calculus, typed, information, structure)
...
*/
	...
	struct min
	{
		...
		<
			if_then
			<
				perkei_is_equal<RegType, unsigned char>,
				typed_list<size_type, 0>

			>, else_then
			<
				perkei_is_equal<RegType, unsigned short>,
				typed_list<size_type, 0>

			>, else_then
			<
				perkei_is_equal<RegType, unsigned int>,
				typed_list<size_type, 0>

			>, else_then
			<
				perkei_is_equal<RegType, unsigned long>,
				typed_list<size_type, 0>

			>, else_then
			<
				perkei_is_equal<RegType, unsigned long long>,
				typed_list<size_type, 0>

			>, else_then
			<
				perkei_is_equal<RegType, signed short>,
			...
			>, else_then
			<
				perkei_is_equal<RegType, signed int>,
				typed_list<size_type, size_type(INT_MIN)>

			>, else_then
			<
				perkei_is_equal<RegType, signed long>,
				typed_list<size_type, size_type(LONG_MIN)>

			>, else_then
			<
				perkei_is_equal<RegType, signed long long>,
