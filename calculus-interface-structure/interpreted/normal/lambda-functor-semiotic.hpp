...
*/
	...
	template<typename...> struct procedure_make;

	template<typename Args, typename Body, typename Func>
	struct procedure_make<Args, Body, Func>
	{
		using rtn = procedure
		<
			typename Args::rtn,

			typename relabel<Body, lambda>::rtn,
	...
	struct procedure_make<Args, Body, Func, Env>
	{
		using rtn = procedure
		<
			typename Args::rtn,
	...
	struct procedure_make<Args, Body, Func, Env, Frame>
	{
		using rtn = procedure
		<
			typename Args::rtn,
...
*/
	...
	inline static void display(const arguments<> &)
	{
	...
	inline static void display(const body<> &)
	{
