...
#define pnk_function_ss nik_module(patronum, natural, kernel, function, symbolic, semiotic)
	...
	#define PREFIX		pnkf_embedding_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_function_)					= typename pnk_function_ss::embedding::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_function_)		= pnk_function_ss::embedding::template
