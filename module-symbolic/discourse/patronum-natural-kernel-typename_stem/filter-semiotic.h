...
#define pnk_typename_stem_ss nik_module(patronum, natural, kernel, typename_stem, symbolic, semiotic)
	...
	#define PREFIX		pnkts_filter_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_typename_stem_)					= typename pnk_typename_stem_ss::filter::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_typename_stem_)		= pnk_typename_stem_ss::filter::template
