...
#define snk_wchar_t_judgment_ss nik_module(straticum, natural, kernel, wchar_t_judgment, symbolic, semiotic)
	...
	#define PREFIX		snkwtj_navigator_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_wchar_t_judgment_)					= typename snk_wchar_t_judgment_ss::navigator::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_wchar_t_judgment_)		= snk_wchar_t_judgment_ss::navigator::template
