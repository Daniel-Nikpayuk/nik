...
#define pnk_judgment_ss nik_module(patronum, natural, kernel, judgment, symbolic, semiotic)
	...
	#define PREFIX		pnkj_structure_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_judgment_)					= typename pnk_judgment_ss::structure::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_judgment_)		= pnk_judgment_ss::structure::template
