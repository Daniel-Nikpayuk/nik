...
#define snk_unsigned_char_judgment_ss nik_module(straticum, natural, kernel, unsigned_char_judgment, symbolic, semiotic)
	...
	#define PREFIX		snkucj_filter_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_unsigned_char_judgment_)					= typename snk_unsigned_char_judgment_ss::filter::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_unsigned_char_judgment_)		= snk_unsigned_char_judgment_ss::filter::template
