...
#define snk_bool_judgment_ss nik_module(straticum, natural, kernel, bool_judgment, symbolic, semiotic)
	...
	#define PREFIX		snkbj_structure_ss_
...
//
										  ...
										  <
											...
											ch_s_grow_to_values
										  >
	using nik_safe(PREFIX, s_bool_judgment_)					= typename snk_bool_judgment_ss::structure::template
...
//
										  ...
										  <
											...
											typename Image = Type
										  >
	static constexpr Image nik_safe(PREFIX, a_bool_judgment_)		= snk_bool_judgment_ss::structure::template
